...
export class Migration1714139328627 implements MigrationInterface {
    name = 'Migration1714139328627'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "movie" ("id" SERIAL NOT NULL, "title" character varying(128) NOT NULL, "description" character varying(2048) NOT NULL, "release_date" TIMESTAMP NOT NULL, "rating" integer, "poster_url" character varying, CONSTRAINT "PK_cb3bb4d61cf764dc035cbedd422" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "name" character varying(64) NOT NULL, "description" character varying(256), CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "movie_category" ("movie_id" integer NOT NULL, "category_id" integer NOT NULL, CONSTRAINT "PK_863112691ec73f8eddee559d777" PRIMARY KEY ("movie_id", "category_id"))`);
